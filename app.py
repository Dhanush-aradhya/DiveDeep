...
# ========== PAGE CONFIGURATION ========== #
st.set_page_config(
    page_title="DiveDeep AI Research Assistant",
    layout="wide",
...
# ========== STREAMLIT LAYOUT ========== #
st.markdown('<h1 class="title">AI-ResearchBot</h1>', unsafe_allow_html=True)
...
if st.session_state.results:
    ...
    if results.get("status", "error").startswith("success"):
        ...
        ask_follow_up = st.button("💬 Ask ResearchBot", key="follow_up_button")
...
# --- Footer ---
st.markdown('<p class="footer">DiveDeep AI Research Assistant - Final Round</p>', unsafe_allow_html=True)